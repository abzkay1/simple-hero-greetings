...
const Hero: React.FC = () => {
  return <section className="relative h-screen flex items-center justify-center" id="home">
      ...
      <div className="container relative z-10 text-center">
        <div className="mb-6 fade-in px-[144px] mx-[47px] my-[10px] py-0">
          <img src="/lovable-uploads/e21b92a2-7799-4a6c-9206-7de4c90dbf31.png" alt="Prestige Spray" className="h-auto w-4/5 md:w-3/4 lg:w-2/3 mx-auto" />
        </div>
