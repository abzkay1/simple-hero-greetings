  ...
  return (
    <div className={`relative bg-dark-secondary p-8 rounded-lg shadow-lg border ${
      ...
      <div className="text-center mb-6">
        <h3 className="text-2xl font-bold mb-2 text-gold">{title}</h3>
        <div className="mb-3">
      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12 mb-16">
          <PricingCard
            title="Small Areas"
            price="£7/m²"
            description="Perfect for smaller driveways, patios, or targeted cleaning"
            features={[
              "0-25 m² coverage",
              "£200 minimum charge",
          ...
          <PricingCard
            title="Medium Areas"
            price="£7/m²"
            description="Ideal for medium-sized properties and larger cleaning projects"
            features={[
              "26-50 m² coverage",
              "£200-£350 total cost",
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-dark-secondary p-6 rounded-lg border border-gray-800 text-center">
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-gold-secondary to-gold p-8 rounded-lg text-center">
          <h3 className="text-2xl font-bold text-dark-bg mb-4">Ready to Transform Your Property?</h3>
          <p className="text-dark-bg mb-6 text-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="btn bg-dark-bg text-gold hover:bg-dark-secondary transition-all duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a 
              ...
              className="btn border-2 border-dark-bg text-dark-bg hover:bg-dark-bg hover:text-gold transition-all duration-300"
            >
